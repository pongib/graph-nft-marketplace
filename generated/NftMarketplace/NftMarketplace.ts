...
export class WithdrawSellerFund extends ethereum.Event {
  get params(): WithdrawSellerFund__Params {
    return new WithdrawSellerFund__Params(this);
  }
}

export class WithdrawSellerFund__Params {
  _event: WithdrawSellerFund;

  constructor(event: WithdrawSellerFund) {
    this._event = event;
  }
...
export class NftMarketplace extends ethereum.SmartContract {
  ...
  getSellerFund(seller: Address): BigInt {
    let result = super.call(
      "getSellerFund",
      "getSellerFund(address):(uint256)",
  ...
  try_getSellerFund(seller: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "getSellerFund",
      "getSellerFund(address):(uint256)",
      [ethereum.Value.fromAddress(seller)]
...
export class WithdrawSellerFundCall extends ethereum.Call {
  get inputs(): WithdrawSellerFundCall__Inputs {
    return new WithdrawSellerFundCall__Inputs(this);
  }

  get outputs(): WithdrawSellerFundCall__Outputs {
    return new WithdrawSellerFundCall__Outputs(this);
  }
}

export class WithdrawSellerFundCall__Inputs {
  _call: WithdrawSellerFundCall;

  constructor(call: WithdrawSellerFundCall) {
    this._call = call;
  }
}

export class WithdrawSellerFundCall__Outputs {
  _call: WithdrawSellerFundCall;
